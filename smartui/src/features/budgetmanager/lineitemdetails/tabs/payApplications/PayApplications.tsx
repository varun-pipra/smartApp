...
import PayApplicationsGrid from './PayApplicationsGrid';
...
const PayApplications = (props: any) => {
	...
	return <Box className='pay-applications-box'>
		<div className='pay-applications-header'>
			<div className='title-action'>
				<span className='title'>Pay Applications</span>
			</div>
			<div className='pay-applications-kpi-fields'>
				<span className='kpi-item-tile'>
					<div className='kpi-label'>Total Quantity of Pay Apps</div>
				...
				<span className='kpi-item-tile'>
					<div className='kpi-label'>Total Payment Amount</div>
					<div className='kpi-field-container'>
						{gridIcon}
						<span className='kpi-value'>
							{currencySymbol}{' 0.00'}
		...
		<div className='pay-applications-list'>
			<PayApplicationsGrid groupAndFilterData={groupAndFilterData} />
		</div>
	</Box>;
};
