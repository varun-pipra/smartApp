          ...
          <span className="eventrequest-info-tile">
            <div className="type-field">
              ...
              <SmartDropDown
                ...
                selectedValue={
                  detailsData.category ? detailsData.category.name : ""
                }
                outSideOfGrid={true}
                isSearchField={false}
                isFullWidth
          ...
          <span className="eventrequest-info-tile">
            <div className="type-field">
              ...
              <SmartDropDown
                ...
                selectedValue={detailsData.phase ? detailsData.phase.name : ""}
                outSideOfGrid={true}
                isSearchField={true}
                isFullWidth
                Placeholder={"Select"}
          ...
          <span className="eventrequest-info-tile">
            <div className="type-field">
              ...
              <SmartDropDown
                ...
                outSideOfGrid={true}
                selectedValue={detailsData.trades || []}
                isSearchField={true}
                Placeholder={"Select"}
                ignoreSorting={true}
                isFullWidth
        ...
        <div className="eventrequest-details-content">
          <div className="eventrequest-info-data-box">
            ...
            <DatePickerComponent
              ...
              defaultValue={formatDate(detailsData?.startDate, {
                year: "numeric",
                month: "2-digit",
                day: "2-digit",
              })}
          ...
          <div className="eventrequest-info-data-box">
            ...
            <DatePickerComponent
              containerClassName={"iq-customdate-cont"}
              defaultValue={formatDate(detailsData?.endDate, {
                year: "numeric",
                month: "2-digit",
                day: "2-digit",
              })}
