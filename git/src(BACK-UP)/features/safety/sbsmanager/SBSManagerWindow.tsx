  ...
  const columns = [
    ...
    },
    {
      ...
      cellRenderer: (params: any) => {
        ...
        return !params.data.configureSupplementalInfo ?(
          <div
            className="sbs-suppli-info-cell"
            onClick={() => {
              console.log(params.data.configureSupplementalInfo,"params.data.configureSupplementalInfo")
              if(params.data.configureSupplementalInfo){
