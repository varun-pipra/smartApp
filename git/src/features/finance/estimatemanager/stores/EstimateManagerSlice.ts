...
import {fetchGridDataList} from './EstimateManagerAPI';

export interface EstimateManagerDataState {
	loading: boolean;
	originalGridApiData: any;
	gridData: any;
};

const initialState: EstimateManagerDataState = {
	loading: false,
	originalGridApiData: [],
	gridData: [],
};
...
export const estimateBudgetSlice = createSlice({
	name: 'gridData',
	initialState,
...
} = estimateBudgetSlice.actions;

export default estimateBudgetSlice.reducer;