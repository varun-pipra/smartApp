        ...
        <span className="budget-info-tile">
          ...
          <div className="budget-info-data-box">
            ...
            <span
              ...
              onClick={() => {
                window.open(
                  `${appInfo?.hostUrl}/EnterpriseDesktop/DesktopClientUI/AppZoneV2/appholder/?url=https://react.smartappbeta.com/bid-manager/home?id=${formData?.bidPackage?.id}#react`,
                  "_blank"
                );
              }}
            >
        ...
        <span className="budget-info-tile">
          ...
          <div className="budget-info-data-box">
            ...
            <span
              ...
              onClick={() =>
                window.open(
                  `${appInfo.hostUrl}/EnterpriseDesktop/DesktopClientUI/AppZoneV2/appholder/?url=https://react.smartappbeta.com/vendor-contracts/home?id=${formData?.vendorContract?.id}#react`,
                  "_blank"
                )
              }
            >
        ...
        <span className="budget-info-tile">
          ...
          <div className="budget-info-data-box">
            ...
            <span
              ...
              onClick={() =>
                window.open(
                  `${appInfo.hostUrl}/EnterpriseDesktop/DesktopClientUI/AppZoneV2/appholder/?url=https://react.smartappbeta.com/client-contracts/home?id=${formData?.clientContract?.id}#react`,
                  "_blank"
                )
              }
            >
