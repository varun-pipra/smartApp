...
export const gridDataSlice = createSlice({
	...
	reducers: {
		...
		setBudgetIframeActive: (state, action: PayloadAction<any>) => {
			state.budgetIframeActive = action.payload;
		},
	},
