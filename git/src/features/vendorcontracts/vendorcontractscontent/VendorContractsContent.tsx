...
import {
	...
	setShowLineItemDetails, getBidLookup, getContractDetailsById, setLockAndPostContractResponseClick,
	getMinMaxDrawerStatus, setMinMaxDrawerStatus
...
import { setPostAndLockResponseClick, getVCChangeEventsList } from '../stores/VCChangeEventsSlice';
					...
					message={
						<div className='message-content'>
							...
							<p>Contract needs to be updated.
								{/* <a onClick={() => window.open(`${appInfo?.hostUrl}/EnterpriseDesktop/DesktopClientUI/AppZoneV2/appholder/?url=https://react.smartappbeta.com/change-event-requests/home?id=${selectedRecord?.id}#react`, '_blank')}>CER001</a> */}
							</p>
