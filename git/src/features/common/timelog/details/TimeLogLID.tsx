	...
	const tabConfig = [
		{
			...
			// content: <TimeLogDetails/>
			content: <>Time Log Details</>
		}, {
			tabId: 'links',
			label: 'Links',
			showCount: false,
	...
	return <div className='kpi-section'>
		<div className='kpi-vertical-container'>
			<div className='lid-details-container'>
				...
				<span className='grey-fontt bold'>TS00198</span>
				<span className='budgetid-label grey-font'>Segment Duration:</span>
				<span className='grey-fontt bold'>6 Hrs 30 Mins</span>
				<span className='last-modified-label grey-font'>Date Created:</span>
				<span className='grey-fontt'>Nov 9,2023 06:44:08 PM by Justin Robinson</span>
			</div>
		</div>
	</div>;
});
	...
	return (
		<div className='title-section'>
			...
			<div className='name-section'>
				<div className='name'>Justin Robinson</div>
				<div className='companyName'>ACME Electrical Inc</div>
			</div>
		</div>
	)
})
