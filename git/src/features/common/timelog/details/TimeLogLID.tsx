	...
	return <div className='kpi-section'>
		<div className='kpi-vertical-container'>
			<div className='lid-details-container'>
				...
				<span className='grey-fontt bold'>{selectedTimeLogDetails?.duration}</span>
	...
	return (
		<div className='title-section'>
			...
			<div className='name-section'>
				<div className='name'>{selectedTimeLogDetails?.createdBy?.name}</div>
				<div className='companyName'>{selectedTimeLogDetails?.company}</div>
			</div>
		</div>
	)
})
