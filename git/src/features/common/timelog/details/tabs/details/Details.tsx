...
const details = (props: any) => {
	...
	const [details, setDetails] = useState<any>({
		...
		userimage: image,
		company: 'ACME Electrical inc',
		email: 'justinrobson@gmail.com',
		startdate: '',
		enddate: '',
	...
	return (
		<div className='timelog-details'>
			<div className='timelog-details-box'>
				...
				<div className='timelog-details-content-col3'>
					...
					<span className='timelog-info-tile'>
						...
						<div className='timelog-info-data-box'>
							...
							<span className='client-contract-info-data'>{details?.company}</span>
						</div>
					</span>
					<span className='timelog-info-tile'>
						...
						<div className='timelog-info-data-box'>
							...
							<span className='client-contract-info-data'>{details?.email}</span>
						</div>
					</span>
				</div>
				...
				<div className='timelog-details-content-col3'>
					...
					<span className='timelog-info-tile'>
						...
						<div className='timelog-info-data-box'>
							...
							<span className='client-contract-info-data'>{details?.source}</span>
						</div>
					</span>
				</div>
				...
				<div className='timelog-details-content-col2'>
					<span className='timelog-info-tile'>
						...
						<div className='timelog-info-data-box'>
							{details?.timeadded == '' || details?.timeadded == null ?
								<SmartDropDown
									name='resource'
								...
								<div className='timeaddedto'>
									<img className='img' src={details?.thumbnail ? details?.thumbnail : ''} />
									<span className='timeadded'>{details?.timeadded}</span>
								</div>
							}
						</div>
					</span>
						...
						<div className='timelog-info-data-box'>
							<TextField
								...
								InputProps={{
									...
									endAdornment: (
										<InputAdornment position='start'>
											<img src={details?.phaseIcon} className='phaseimage' />
										</InputAdornment>
									)
								}}
