...
import { getSBSGridList, setShowSbsPanel,deleteSbsRecords } from '../../operations/sbsManagerSlice';
// import {deleteSbsRecors} from "../../operations/sbsManagerSlice"
...
export const SBSToolbarLeftButtons = memo(() => {
	...
	const deleteChangeEvent = () => {
		...
		dispatch(deleteSbsRecords(selectedIds))
