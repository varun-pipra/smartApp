...
// import ChangeEventRequestsSlice from 'features/changeeventrequests/stores/changeEventRequestsSlice';
import BudgetManagerSlice from 'features/budgetmanager1/store/BudgetManagerSlice';
...
export const store = configureStore({
  reducer: {
    ...
    budgetManager: BudgetManagerSlice,
